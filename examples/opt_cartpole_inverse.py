...
from diffsqp.dynamics import CartPoleInverseDynamics
from diffsqp.solvers import EqualityConstrainedLqr
...
Q = 1e-4 * torch.eye(n_state).repeat(n_batch, 1, 1)
...
# solver = EqualityConstrainedLqr(prob)
# solver.solve()
